        ...
        if (dateRangeMatch) {
          ...
          if (!aiResponse._dateError) {
            ...
            if (startDate < now && !isStartToday) {
              aiResponse._dateError = `⚠️ Ngày bắt đầu **${startDay}/${startMonth}/${startYear}** đã là quá khứ!\n\nHôm nay: ${today.getDate()}/${today.getMonth() + 1}/${today.getFullYear()}\n\n💡 Vui lòng nhập lại với ngày từ hôm nay trở đi:\n📝 Ví dụ: từ **${today.getDate()}/${today.getMonth() + 1}/${today.getFullYear()}** đến **DD/MM/YYYY**`;
